...
public class RestaurantControllerTest {
    ...
    public void getAllRestaurants_shouldReturnRestaurants() throws Exception {
        RestaurantResponseDTO restaurant = new RestaurantResponseDTO(1L, "Great Food", "Main St 123", Collections.emptyList(), Collections.emptyList());
    ...
    public void createRestaurant_whenRestaurant_shouldCreateRestaurant() throws Exception {
        ...
        RestaurantResponseDTO response = new RestaurantResponseDTO(1L, "New Restaurant", "Address", Collections.emptyList(), Collections.emptyList());
    ...
    public void updateRestaurant_whenRestaurant_shouldUpdateRestaurant() throws Exception {
        RestaurantRequestDTO request = new RestaurantRequestDTO("Updated Restaurant", "Address", List.of(1L), List.of(1L));
        RestaurantResponseDTO response = new RestaurantResponseDTO(1L, "Updated Restaurant", "Address", Collections.emptyList(), Collections.emptyList());
